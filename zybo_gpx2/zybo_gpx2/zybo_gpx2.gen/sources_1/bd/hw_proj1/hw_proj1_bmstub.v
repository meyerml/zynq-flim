...
module hw_proj1 (
  ...
  (* X_INTERFACE_IGNORE = "true" *)
  output [0:0]cs_n;
  (* X_INTERFACE_INFO = "xilinx.com:signal:interrupt:1.0 INTR.PMOD_ACL_INT1 INTERRUPT" *)
  (* X_INTERFACE_MODE = "slave INTR.PMOD_ACL_INT1" *)
  (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME INTR.PMOD_ACL_INT1, SENSITIVITY LEVEL_HIGH, PortWidth 1" *)
  input PMOD_ACL_INT1;
  (* X_INTERFACE_INFO = "xilinx.com:signal:interrupt:1.0 INTR.PMOD_ACL_INT2 INTERRUPT" *)
  (* X_INTERFACE_MODE = "slave INTR.PMOD_ACL_INT2" *)
  (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME INTR.PMOD_ACL_INT2, SENSITIVITY LEVEL_HIGH, PortWidth 1" *)
  input PMOD_ACL_INT2;
