...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix is
  ...
  attribute CORE_GENERATION_INFO of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix : entity is "spi_to_dma_spi_fifo_axis_module_0_0,spi_fifo_axis_module,{x_ipProduct=Vivado 2024.2,x_ipVendor=xilinx.com,x_ipLibrary=user,x_ipName=spi_fifo_axis_module,x_ipVersion=3.1,x_ipCoreRevision=2,x_ipLanguage=VERILOG,x_ipSimLanguage=MIXED}";
...
architecture stub of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix is
  ...
  attribute black_box_pad_pin of stub : architecture is "aresetn,buffer_empty,buffer_full,cs_n,m_axis_0_tdata[31:0],m_axis_0_tlast,m_axis_0_tready,m_axis_0_tstrb[3:0],m_axis_0_tvalid,o_fifo_read_en,o_ready,o_rx_byte_valid_tick,o_transfer_done_tick_0,rd_data_count[7:0],read_clock,spi_en,spi_intr,spi_miso,spi_mosi,spi_sclk,write_clock";
