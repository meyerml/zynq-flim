...
/* Definitions for peripheral CS_N1 */
#define XPAR_CS_N1_BASEADDR 0x41200000
#define XPAR_CS_N1_HIGHADDR 0x4120FFFF
#define XPAR_CS_N1_DEVICE_ID 1
#define XPAR_CS_N1_INTERRUPT_PRESENT 0
#define XPAR_CS_N1_IS_DUAL 0


/* Definitions for peripheral SPI_MUX_SELECT_2 */
#define XPAR_SPI_MUX_SELECT_2_BASEADDR 0x41210000
#define XPAR_SPI_MUX_SELECT_2_HIGHADDR 0x4121FFFF
#define XPAR_SPI_MUX_SELECT_2_DEVICE_ID 2
#define XPAR_SPI_MUX_SELECT_2_INTERRUPT_PRESENT 0
#define XPAR_SPI_MUX_SELECT_2_IS_DUAL 0


/* Definitions for peripheral AXIS_ENABLE */
#define XPAR_AXIS_ENABLE_BASEADDR 0x41230000
#define XPAR_AXIS_ENABLE_HIGHADDR 0x4123FFFF
#define XPAR_AXIS_ENABLE_DEVICE_ID 3
#define XPAR_AXIS_ENABLE_INTERRUPT_PRESENT 0
#define XPAR_AXIS_ENABLE_IS_DUAL 0
...
/* Canonical definitions for peripheral CS_N1 */
#define XPAR_GPIO_1_BASEADDR 0x41200000
#define XPAR_GPIO_1_HIGHADDR 0x4120FFFF
#define XPAR_GPIO_1_DEVICE_ID XPAR_CS_N1_DEVICE_ID
#define XPAR_GPIO_1_INTERRUPT_PRESENT 0
#define XPAR_GPIO_1_IS_DUAL 0

/* Canonical definitions for peripheral SPI_MUX_SELECT_2 */
#define XPAR_GPIO_2_BASEADDR 0x41210000
#define XPAR_GPIO_2_HIGHADDR 0x4121FFFF
#define XPAR_GPIO_2_DEVICE_ID XPAR_SPI_MUX_SELECT_2_DEVICE_ID
#define XPAR_GPIO_2_INTERRUPT_PRESENT 0
#define XPAR_GPIO_2_IS_DUAL 0

/* Canonical definitions for peripheral AXIS_ENABLE */
#define XPAR_GPIO_3_BASEADDR 0x41230000
#define XPAR_GPIO_3_HIGHADDR 0x4123FFFF
#define XPAR_GPIO_3_DEVICE_ID XPAR_AXIS_ENABLE_DEVICE_ID
