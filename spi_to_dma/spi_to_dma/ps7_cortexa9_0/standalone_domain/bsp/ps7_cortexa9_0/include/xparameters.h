...
#define XPAR_CS_N1_DEVICE_ID 0
#define XPAR_CS_N1_INTERRUPT_PRESENT 0
#define XPAR_CS_N1_IS_DUAL 0


/* Definitions for peripheral SPI_MUX_SELECT */
#define XPAR_SPI_MUX_SELECT_BASEADDR 0x41210000
#define XPAR_SPI_MUX_SELECT_HIGHADDR 0x4121FFFF
#define XPAR_SPI_MUX_SELECT_DEVICE_ID 1
#define XPAR_SPI_MUX_SELECT_INTERRUPT_PRESENT 0
#define XPAR_SPI_MUX_SELECT_IS_DUAL 0
...
#define XPAR_GPIO_0_DEVICE_ID XPAR_CS_N1_DEVICE_ID
#define XPAR_GPIO_0_INTERRUPT_PRESENT 0
#define XPAR_GPIO_0_IS_DUAL 0

/* Canonical definitions for peripheral SPI_MUX_SELECT */
#define XPAR_GPIO_1_BASEADDR 0x41210000
#define XPAR_GPIO_1_HIGHADDR 0x4121FFFF
#define XPAR_GPIO_1_DEVICE_ID XPAR_SPI_MUX_SELECT_DEVICE_ID
