...
entity spi_to_dma_spi_fifo_axis_module_0_0 is
  ...
  attribute CORE_GENERATION_INFO of spi_to_dma_spi_fifo_axis_module_0_0 : entity is "spi_to_dma_spi_fifo_axis_module_0_0,spi_fifo_axis_module,{x_ipProduct=Vivado 2024.2,x_ipVendor=xilinx.com,x_ipLibrary=user,x_ipName=spi_fifo_axis_module,x_ipVersion=1.0,x_ipCoreRevision=3,x_ipLanguage=VERILOG,x_ipSimLanguage=MIXED}";
...
architecture stub of spi_to_dma_spi_fifo_axis_module_0_0 is
  attribute syn_black_box : boolean;
  attribute black_box_pad_pin : string;
  attribute syn_black_box of stub : architecture is true;
  attribute black_box_pad_pin of stub : architecture is "aresetn,m_axis_0_tdata[31:0],m_axis_0_tlast,m_axis_0_tready,m_axis_0_tstrb[3:0],m_axis_0_tvalid,read_clock,spi_intr,spi_miso,spi_mosi,spi_sclk,write_clock";
