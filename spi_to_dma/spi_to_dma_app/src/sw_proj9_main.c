...
/*****************************/
u32 membuffer[4] = {0xDEADC0DE, 0xDEADC0DE, 0xDEADC0DE, 0xDEADC0DE};
int main(void)
{
...
#if MAIN_DEBUG
	printf("\n\r------------------------------------------------------------\n\r");
	printf("----------- Zynq Fundamentals Software Project 9 -----------\n\r");
	printf("------------------------------------------------------------\n\r");
	printf("Title: Programmable Logic Interrupts: PmodACL.\r\n");
