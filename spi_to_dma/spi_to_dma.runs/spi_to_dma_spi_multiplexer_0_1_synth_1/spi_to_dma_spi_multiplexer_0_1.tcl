...
synth_design -top spi_to_dma_spi_multiplexer_0_1 -part xc7z020clg400-1 -incremental_mode off -mode out_of_context
OPTRACE "synth_design" END { }
if { [get_msg_config -count -severity {CRITICAL WARNING}] > 0 } {
 send_msg_id runtcl-6 info "Synthesis results are not added to the cache due to CRITICAL_WARNING"
}

rename_ref -prefix_all spi_to_dma_spi_multiplexer_0_1_

OPTRACE "write_checkpoint" START { CHECKPOINT }
# disable binary constraint mode for synth run checkpoints
set_param constraints.enableBinaryConstraints false
write_checkpoint -force -noxdef spi_to_dma_spi_multiplexer_0_1.dcp
OPTRACE "write_checkpoint" END { }
OPTRACE "synth reports" START { REPORT }
generate_parallel_reports -reports { "report_utilization -file spi_to_dma_spi_multiplexer_0_1_utilization_synth.rpt -pb spi_to_dma_spi_multiplexer_0_1_utilization_synth.pb"  } 
...
OPTRACE "spi_to_dma_spi_multiplexer_0_1_synth_1" END { }
