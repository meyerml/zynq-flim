...
EAStep vivado -log spi_to_dma_spi_multiplexer_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source spi_to_dma_spi_multiplexer_0_1.tcl
