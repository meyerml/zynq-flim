...
HD_PWD='C:/Users/marce/OneDrive/Desktop/zync_proj/2024.2/zybo_z7_20/spi_to_dma/spi_to_dma.runs/spi_to_dma_spi_mux_select_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log spi_to_dma_spi_mux_select_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source spi_to_dma_spi_mux_select_0.tcl
