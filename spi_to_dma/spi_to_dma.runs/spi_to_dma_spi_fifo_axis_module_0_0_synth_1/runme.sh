...
HD_PWD='C:/Users/marce/OneDrive/Dokumente/zynq_project/spi_to_dma/spi_to_dma.runs/spi_to_dma_spi_fifo_axis_module_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log spi_to_dma_spi_fifo_axis_module_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source spi_to_dma_spi_fifo_axis_module_0_0.tcl
