...
#
# Script generated by Vivado on Thu May 15 15:14:19 +0200 2025
# SW Build 5239630 on Fri Nov 08 22:35:27 MST 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : spi_to_dma.sh
...
#
# Usage        : spi_to_dma.sh
#                spi_to_dma.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                spi_to_dma.sh [-reset_run]
#                spi_to_dma.sh [-reset_log]
#                spi_to_dma.sh [-help]
#
...
# script info
echo -e "spi_to_dma.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./spi_to_dma.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb spi_to_dma.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./spi_to_dma.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: spi_to_dma.sh [-help]\n\
Usage: spi_to_dma.sh [-step]\n\
Usage: spi_to_dma.sh [-lib_map_path]\n\
Usage: spi_to_dma.sh [-reset_run]\n\
Usage: spi_to_dma.sh [-reset_log]\n\
Usage: spi_to_dma.sh [-keep_index]\n\
Usage: spi_to_dma.sh [-noclean_files]\n\n\
