...
(* CORE_GENERATION_INFO = "TEST_PATTERN_TO_AXIS,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=TEST_PATTERN_TO_AXIS,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=9,numReposBlks=9,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=4,numPkgbdBlks=1,bdsource=USER,da_clkrst_cnt=2,synth_mode=Hierarchical}" *) (* HW_HANDOFF = "TEST_PATTERN_TO_AXIS.hwdef" *) 
module TEST_PATTERN_TO_AXIS
  ...
  wire [0:0]LED_OUT_1;
  wire [0:0]LED_OUT_2;
  wire [47:0]LVDS_to_AXIS_0_M_AXIS_0_TDATA;
  wire LVDS_to_AXIS_0_M_AXIS_0_TLAST;
  wire LVDS_to_AXIS_0_M_AXIS_0_TVALID;
  wire LVDS_to_AXIS_0_single_ended_frame;
  wire LVDS_to_AXIS_0_single_ended_l_clk_in;
  wire LVDS_to_AXIS_0_single_ended_sdo;
  wire clk;
  wire frame_n;
  wire frame_p;
  wire l_clk_in_n;
  ...
  TEST_PATTERN_TO_AXIS_LED_wrapper_0_1 FRAME_LED_COUNTER
       (.CLK(LVDS_to_AXIS_0_single_ended_frame),
        .LED_OUT(LED_OUT_1));
  TEST_PATTERN_TO_AXIS_LVDS_to_AXIS_0_0 LVDS_to_AXIS_0
       (.M_AXIS_0_tdata(LVDS_to_AXIS_0_M_AXIS_0_TDATA),
        ...
        .msglen(xlconstant_0_dout),
        .sdo_n(sdo_n),
        .sdo_p(sdo_p),
        .single_ended_frame(LVDS_to_AXIS_0_single_ended_frame),
        .single_ended_l_clk_in(LVDS_to_AXIS_0_single_ended_l_clk_in),
        .single_ended_sdo(LVDS_to_AXIS_0_single_ended_sdo));
  TEST_PATTERN_TO_AXIS_LED_wrapper_0_0 L_CLK_IN_LED_COUNTER
       (.CLK(LVDS_to_AXIS_0_single_ended_l_clk_in),
        .LED_OUT(LED_OUT_0));
  TEST_PATTERN_TO_AXIS_xlconstant_0_0 MSGLEN
       (.dout(xlconstant_0_dout));
  TEST_PATTERN_TO_AXIS_LED_wrapper_1_0 SDO_LED_COUNTER
       (.CLK(LVDS_to_AXIS_0_single_ended_sdo),
        .LED_OUT(LED_OUT_2));
  TEST_PATTERN_TO_AXIS_ila_0_0 ila_0
       (.clk(clk),
        .probe0(1'b1),
        .probe1({1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,LVDS_to_AXIS_0_M_AXIS_0_TDATA}),
        ...
        .probe7(1'b0),
        .probe8(1'b0));
  TEST_PATTERN_TO_AXIS_ila_1_0 ila_1
       (.clk(clk),
        .probe0(LVDS_to_AXIS_0_single_ended_l_clk_in),
        .probe1(LVDS_to_AXIS_0_single_ended_frame),
        .probe2(LVDS_to_AXIS_0_single_ended_sdo));
