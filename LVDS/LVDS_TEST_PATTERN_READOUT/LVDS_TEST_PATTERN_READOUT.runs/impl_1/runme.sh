...
HD_PWD='C:/Users/marce/OneDrive/Dokumente/zynq_project/LVDS/LVDS_TEST_PATTERN_READOUT/LVDS_TEST_PATTERN_READOUT.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log TEST_PATTERN_TO_AXIS_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source TEST_PATTERN_TO_AXIS_wrapper.tcl -notrace
