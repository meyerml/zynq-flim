...
HD_PWD='C:/Users/marce/OneDrive/Dokumente/zynq_project/LVDS/LVDS_TEST_PATTERN_READOUT/LVDS_TEST_PATTERN_READOUT.runs/TEST_PATTERN_TO_AXIS_ila_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log TEST_PATTERN_TO_AXIS_ila_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source TEST_PATTERN_TO_AXIS_ila_0_0.tcl
