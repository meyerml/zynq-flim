...
HD_PWD='C:/Users/marce/OneDrive/Dokumente/zynq_project/LVDS/LVDS_TEST_PATTERN_READOUT/LVDS_TEST_PATTERN_READOUT.runs/LED_c_counter_binary_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log LED_c_counter_binary_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source LED_c_counter_binary_0_0.tcl
