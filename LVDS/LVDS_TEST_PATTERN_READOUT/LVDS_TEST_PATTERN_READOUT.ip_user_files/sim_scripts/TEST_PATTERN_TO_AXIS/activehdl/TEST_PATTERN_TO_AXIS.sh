...
#                script (type 'TEST_PATTERN_TO_AXIS.sh -help' for more information).
#
...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="C:/Users/marce/OneDrive/Dokumente/zynq_project/LVDS/LVDS_TEST_PATTERN_READOUT/LVDS_TEST_PATTERN_READOUT.cache/compile_simlib/activehdl"
  fi
  if [[ ($lib_map_path != "") ]]; then
