...
#define LED1_TOGGLE_COUNT			400U
#define LED2_TOGGLE_COUNT			200U
...
void task2(u32 *destination, u32 read_samples, u8 print_refindices, u8 print_results, u8 print_statistics);
