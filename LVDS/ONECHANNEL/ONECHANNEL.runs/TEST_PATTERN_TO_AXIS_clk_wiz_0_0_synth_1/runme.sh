...
HD_PWD='C:/Users/marce/OneDrive/Dokumente/zynq_project/LVDS/ONECHANNEL/ONECHANNEL.runs/TEST_PATTERN_TO_AXIS_clk_wiz_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log TEST_PATTERN_TO_AXIS_clk_wiz_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source TEST_PATTERN_TO_AXIS_clk_wiz_0_0.tcl
