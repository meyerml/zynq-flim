...
(* CHECK_LICENSE_TYPE = "TEST_PATTERN_TO_AXIS_LVDS_to_AXIS_debug_0_0,LVDS_to_AXIS,{}" *) (* CORE_GENERATION_INFO = "TEST_PATTERN_TO_AXIS_LVDS_to_AXIS_debug_0_0,LVDS_to_AXIS,{x_ipProduct=Vivado 2024.2,x_ipVendor=xilinx.com,x_ipLibrary=user,x_ipName=LVDS_to_AXIS_debug,x_ipVersion=1.3,x_ipCoreRevision=2,x_ipLanguage=VERILOG,x_ipSimLanguage=MIXED}" *) (* DowngradeIPIdentifiedWarnings = "yes" *) 
