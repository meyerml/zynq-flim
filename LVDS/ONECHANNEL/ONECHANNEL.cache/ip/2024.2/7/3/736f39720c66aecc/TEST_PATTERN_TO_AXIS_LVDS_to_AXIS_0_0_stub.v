...
(* CHECK_LICENSE_TYPE = "TEST_PATTERN_TO_AXIS_LVDS_to_AXIS_0_0,LVDS_to_AXIS,{}" *) (* CORE_GENERATION_INFO = "TEST_PATTERN_TO_AXIS_LVDS_to_AXIS_0_0,LVDS_to_AXIS,{x_ipProduct=Vivado 2024.2,x_ipVendor=xilinx.com,x_ipLibrary=user,x_ipName=LVDS_to_AXIS,x_ipVersion=1.1,x_ipCoreRevision=2,x_ipLanguage=VERILOG,x_ipSimLanguage=MIXED}" *) (* DowngradeIPIdentifiedWarnings = "yes" *) 
...
module decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix(M_AXIS_0_tdata, M_AXIS_0_tlast, 
  ...
  single_ended_sdo)
/* synthesis syn_black_box black_box_pad_pin="M_AXIS_0_tdata[47:0],M_AXIS_0_tlast,M_AXIS_0_tready,M_AXIS_0_tvalid,aresetn,en,frame_n,frame_p,l_clk_in_n,l_clk_in_p,l_clk_out_n,l_clk_out_p,msglen[5:0],sdo_n,sdo_p,single_ended_frame,single_ended_sdo" */
