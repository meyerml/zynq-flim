...
#
# Script generated by Vivado on Mon Aug 18 15:41:17 +0200 2025
# SW Build 5239630 on Fri Nov 08 22:35:27 MST 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : TEST_PATTERN_TO_AXIS.sh
...
#
# Usage        : TEST_PATTERN_TO_AXIS.sh
#                TEST_PATTERN_TO_AXIS.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                TEST_PATTERN_TO_AXIS.sh [-reset_run]
#                TEST_PATTERN_TO_AXIS.sh [-reset_log]
#                TEST_PATTERN_TO_AXIS.sh [-help]
#
...
# script info
echo -e "TEST_PATTERN_TO_AXIS.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./TEST_PATTERN_TO_AXIS.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L xlconstant_v1_1_9 -L axis_infrastructure_v1_1_1 -L axis_data_fifo_v2_0_15 -L uvm -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot TEST_PATTERN_TO_AXIS xil_defaultlib.TEST_PATTERN_TO_AXIS xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim TEST_PATTERN_TO_AXIS -key {Behavioral:toplevel:Functional:TEST_PATTERN_TO_AXIS} -tclbatch cmd.tcl -protoinst "protoinst_files/LED.protoinst" -protoinst "protoinst_files/TEST_PATTERN_TO_AXIS.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb TEST_PATTERN_TO_AXIS.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./TEST_PATTERN_TO_AXIS.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: TEST_PATTERN_TO_AXIS.sh [-help]\n\
Usage: TEST_PATTERN_TO_AXIS.sh [-step]\n\
Usage: TEST_PATTERN_TO_AXIS.sh [-lib_map_path]\n\
Usage: TEST_PATTERN_TO_AXIS.sh [-reset_run]\n\
Usage: TEST_PATTERN_TO_AXIS.sh [-reset_log]\n\
Usage: TEST_PATTERN_TO_AXIS.sh [-keep_index]\n\
Usage: TEST_PATTERN_TO_AXIS.sh [-noclean_files]\n\n\
