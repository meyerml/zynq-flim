...
HD_PWD='C:/Users/marce/OneDrive/Dokumente/zynq_project/LVDS/clocktest/clocktest.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log clockwizard_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source clockwizard_wrapper.tcl
