...
HD_PWD='C:/Users/marce/OneDrive/Dokumente/zynq_project/LVDS/clocktest/clocktest.runs/clockwizard_clk_wiz_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log clockwizard_clk_wiz_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source clockwizard_clk_wiz_0_0.tcl
