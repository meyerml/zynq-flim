...
HD_PWD='C:/Users/marce/OneDrive/Dokumente/zynq_project/LVDS/clocktest/clocktest.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log clockwizard_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source clockwizard_wrapper.tcl -notrace
