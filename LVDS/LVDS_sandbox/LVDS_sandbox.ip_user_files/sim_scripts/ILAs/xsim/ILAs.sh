...
#
# Script generated by Vivado on Wed Jun 25 12:18:49 +0200 2025
...
#
# Usage        : ILAs.sh
#                ILAs.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                ILAs.sh [-reset_run]
#                ILAs.sh [-reset_log]
#                ILAs.sh [-help]
#
...
# script info
echo -e "ILAs.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./ILAs.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot ILAs xil_defaultlib.ILAs xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim ILAs -key {Behavioral:sim_1:Functional:ILAs} -tclbatch cmd.tcl -protoinst "protoinst_files/ILAs.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb ILAs.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./ILAs.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: ILAs.sh [-help]\n\
Usage: ILAs.sh [-step]\n\
Usage: ILAs.sh [-lib_map_path]\n\
Usage: ILAs.sh [-reset_run]\n\
Usage: ILAs.sh [-reset_log]\n\
Usage: ILAs.sh [-keep_index]\n\
Usage: ILAs.sh [-noclean_files]\n\n\
