...
HD_PWD='C:/Users/marce/OneDrive/Dokumente/zynq_project/LVDS/LVDS_sandbox/LVDS_sandbox.runs/ILAs_ila_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ILAs_ila_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ILAs_ila_0_0.tcl
