...
HD_PWD='C:/Users/marce/OneDrive/Dokumente/zynq_project/LVDS/LVDS_to_axis_production/LVDS_to_axis_production.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log LVDS_to_AXIS_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source LVDS_to_AXIS_wrapper.tcl
