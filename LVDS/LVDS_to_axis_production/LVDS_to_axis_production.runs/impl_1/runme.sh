...
HD_PWD='C:/Users/marce/OneDrive/Dokumente/zynq_project/LVDS/LVDS_to_axis_production/LVDS_to_axis_production.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log LVDS_to_AXIS_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source LVDS_to_AXIS_wrapper.tcl -notrace
