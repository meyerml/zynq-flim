...
#
# Script generated by Vivado on Thu Aug 21 09:36:35 +0200 2025
...
simulate()
{
  xsim LVDS_to_AXIS -key {Behavioral:wrapper:Functional:LVDS_to_AXIS} -tclbatch cmd.tcl -protoinst "protoinst_files/LVDS_to_AXIS.protoinst" -log simulate.log
}
