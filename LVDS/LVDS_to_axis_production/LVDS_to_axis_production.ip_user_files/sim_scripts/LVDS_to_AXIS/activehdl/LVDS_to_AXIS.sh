...
#                script (type 'LVDS_to_AXIS.sh -help' for more information).
#
...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="C:/Users/marce/OneDrive/Dokumente/zynq_project/LVDS/LVDS_to_axis_production/LVDS_to_axis_production.cache/compile_simlib/activehdl"
  fi
  if [[ ($lib_map_path != "") ]]; then
