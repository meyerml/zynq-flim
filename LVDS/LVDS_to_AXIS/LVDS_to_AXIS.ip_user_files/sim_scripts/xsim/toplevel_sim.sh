...
#
# Script generated by Vivado on Wed Aug 13 11:56:29 +0200 2025
# SW Build 5239630 on Fri Nov 08 22:35:27 MST 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : toplevel_sim.sh
...
#
# Usage        : toplevel_sim.sh
#                toplevel_sim.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                toplevel_sim.sh [-reset_run]
#                toplevel_sim.sh [-reset_log]
#                toplevel_sim.sh [-help]
#
...
# script info
echo -e "toplevel_sim.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./toplevel_sim.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L uvm -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot toplevel_sim xil_defaultlib.toplevel_sim xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim toplevel_sim -key {Behavioral:toplevel:Functional:toplevel_sim} -tclbatch cmd.tcl -protoinst "protoinst_files/LED.protoinst" -protoinst "protoinst_files/TEST_PATTERN_TO_AXIS.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb toplevel_sim.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./toplevel_sim.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: toplevel_sim.sh [-help]\n\
Usage: toplevel_sim.sh [-step]\n\
Usage: toplevel_sim.sh [-lib_map_path]\n\
Usage: toplevel_sim.sh [-reset_run]\n\
Usage: toplevel_sim.sh [-reset_log]\n\
Usage: toplevel_sim.sh [-keep_index]\n\
Usage: toplevel_sim.sh [-noclean_files]\n\n\
