...
#define REF_INDEX_BITWIDTH 12 //16 //24 //0(no data out),2,4,8,16,24,6,or 12 bits wide
...
#define DMA_BDS_PER_INTERRUPT 1


#define PULSES_PER_PIXEL 256
#define PIXELS_IN_TOTAL (2 * 2)
#define HIST_BIN_WIDTH 10000  //in picoseconds

#define REFCLK_FREQUENCY 2000  //in kHz
