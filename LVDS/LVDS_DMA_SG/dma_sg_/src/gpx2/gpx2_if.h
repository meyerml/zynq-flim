/******************************************************************************
 * @Title		:	GPX2 Interface (Header File)
 * @Filename	:	gpx2_if.h
 * @Author		:	Derek Murray
...
#ifndef SRC_GPX2_GPX2_IF_H_
#define SRC_GPX2_GPX2_IF_H_
...
/*****************************************************************************/
//#define REFCLK_DIVISIONS 200000 //5 Mhz refclock
//#define REFCLK_DIVISIONS 80000  // 12.5 MHz refclk
...
#define INIT_START_CMD					 0x18
#define POR_CMD					0x30
#define WRITE_CONFIG_CMD					0x80
#define READ_CONFIG_CMD					0x40
#define READ_RESULT_CMD				0x60
...
//#define INT_SOURCE_REG					0x30	//TODO: update this register address
...
//activate inpput channels

extern uint8_t activechannels;

#define LVDS_OUTPUT_ENABLED 0x20;
#define STOP4ACTIVE 0x08
#define STOP3ACTIVE 0x04
#define STOP2ACTIVE 0x02
#define STOP1ACTIVE 0x01

#define REFCLK_ENABLED 0x10
#define LVDS_OUTPUT		0x20
#define DISABLE_ENABLED 0x40
#define RSTIDX_ENABLED	0x80
#define DISABLED		0x00

//resolution settings
#define LOW_RESOLUTION 0x00
#define HIGH_RESOLUTION1 0x40
#define HIGH_RESOLUTION2 0x80

//channel combine possibilities
#define PULSE_SPACING 0x10
#define PULSE_WIDTH 0x20
#define NO_COMBINE 0x00

//reg 2 settings
#define BLOCKWISE_FIFO_READ_ENABLED 0x80
#define COMMON_FIFO_READ_ENABLED 0x40
#define LVS_DOUBLE_DATA_RATE_ENABLED 0x20
