...
#define AXI_GPIO_DEVICE_ID			XPAR_AXI_GPIO_DEVICE_ID
...
typedef enum
{
	...
	LVDS_START, RESERVED1, DISABLE, RESULTCHANNEL0,
	RESULTCHANNEL1, REFRES, LEVEL_SHIFTER_OE, MSGLEN0,
	MSGLEN1, MSGLEN2, MSGLEN3, MSGLEN4, MSGLEN5
}AxiGpio_OutPin_t;
