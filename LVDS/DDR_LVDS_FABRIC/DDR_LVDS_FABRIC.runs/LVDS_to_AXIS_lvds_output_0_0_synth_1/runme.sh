...
HD_PWD='C:/Users/marce/OneDrive/Dokumente/zynq_project/LVDS/LVDS_to_AXIS/LVDS_to_AXIS.runs/LVDS_to_AXIS_lvds_output_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log LVDS_to_AXIS_lvds_output_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source LVDS_to_AXIS_lvds_output_0_0.tcl
