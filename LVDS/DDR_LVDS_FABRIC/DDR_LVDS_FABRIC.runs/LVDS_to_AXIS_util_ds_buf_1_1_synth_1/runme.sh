...
HD_PWD='C:/Users/marce/OneDrive/Dokumente/zynq_project/LVDS/DDR_LVDS_FABRIC/DDR_LVDS_FABRIC.runs/LVDS_to_AXIS_util_ds_buf_1_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log LVDS_to_AXIS_util_ds_buf_1_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source LVDS_to_AXIS_util_ds_buf_1_1.tcl
