...
#                script (type 'toplevel_sim.sh -help' for more information).
#
...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="C:/Users/marce/OneDrive/Dokumente/zynq_project/LVDS/LVDS_to_AXIS/LVDS_to_AXIS.cache/compile_simlib/activehdl"
  fi
  if [[ ($lib_map_path != "") ]]; then
