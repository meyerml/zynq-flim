...
#
# Script generated by Vivado on Mon Oct 27 16:13:22 +0100 2025
# SW Build 5239630 on Fri Nov 08 22:35:27 MST 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : LVDS_to_AXIS.sh
...
#
# Usage        : LVDS_to_AXIS.sh
#                LVDS_to_AXIS.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                LVDS_to_AXIS.sh [-reset_run]
#                LVDS_to_AXIS.sh [-reset_log]
#                LVDS_to_AXIS.sh [-help]
#
...
# script info
echo -e "LVDS_to_AXIS.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./LVDS_to_AXIS.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L axis_infrastructure_v1_1_1 -L axis_data_fifo_v2_0_15 -L util_idelay_ctrl_v1_0_4 -L util_vector_logic_v2_0_4 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot LVDS_to_AXIS xil_defaultlib.LVDS_to_AXIS xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim LVDS_to_AXIS -key {Behavioral:DDR_fabric:Functional:LVDS_to_AXIS} -tclbatch cmd.tcl -protoinst "protoinst_files/LVDS_to_AXIS.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb LVDS_to_AXIS.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./LVDS_to_AXIS.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: LVDS_to_AXIS.sh [-help]\n\
Usage: LVDS_to_AXIS.sh [-step]\n\
Usage: LVDS_to_AXIS.sh [-lib_map_path]\n\
Usage: LVDS_to_AXIS.sh [-reset_run]\n\
Usage: LVDS_to_AXIS.sh [-reset_log]\n\
Usage: LVDS_to_AXIS.sh [-keep_index]\n\
Usage: LVDS_to_AXIS.sh [-noclean_files]\n\n\
