...
--               c:/Users/marce/OneDrive/Dokumente/zynq_project/LVDS/DDR_LVDS_FABRIC/DDR_LVDS_FABRIC.gen/sources_1/bd/LVDS_to_AXIS/ip/LVDS_to_AXIS_util_ds_buf_0_4/LVDS_to_AXIS_util_ds_buf_0_4_sim_netlist.vhdl
-- Design      : LVDS_to_AXIS_util_ds_buf_0_4
...
entity LVDS_to_AXIS_util_ds_buf_0_4_util_ds_buf is
  port (
  ...
  attribute C_BUFGCE_DIV of LVDS_to_AXIS_util_ds_buf_0_4_util_ds_buf : entity is 1;
  attribute C_BUFG_GT_SYNC : integer;
  attribute C_BUFG_GT_SYNC of LVDS_to_AXIS_util_ds_buf_0_4_util_ds_buf : entity is 0;
  attribute C_BUF_TYPE : string;
  attribute C_BUF_TYPE of LVDS_to_AXIS_util_ds_buf_0_4_util_ds_buf : entity is "BUFG";
  attribute C_MODE : string;
  attribute C_MODE of LVDS_to_AXIS_util_ds_buf_0_4_util_ds_buf : entity is "PERFORMANCE";
  attribute C_OBUFDS_GTE5_ADV : string;
  attribute C_OBUFDS_GTE5_ADV of LVDS_to_AXIS_util_ds_buf_0_4_util_ds_buf : entity is "2'b00";
  attribute C_REFCLK_ICNTL_TX : string;
  attribute C_REFCLK_ICNTL_TX of LVDS_to_AXIS_util_ds_buf_0_4_util_ds_buf : entity is "5'b00000";
  attribute C_SIM_DEVICE : string;
  attribute C_SIM_DEVICE of LVDS_to_AXIS_util_ds_buf_0_4_util_ds_buf : entity is "VERSAL_AI_CORE_ES1";
  attribute C_SIZE : integer;
  attribute C_SIZE of LVDS_to_AXIS_util_ds_buf_0_4_util_ds_buf : entity is 1;
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of LVDS_to_AXIS_util_ds_buf_0_4_util_ds_buf : entity is "util_ds_buf";
end LVDS_to_AXIS_util_ds_buf_0_4_util_ds_buf;

architecture STRUCTURE of LVDS_to_AXIS_util_ds_buf_0_4_util_ds_buf is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity LVDS_to_AXIS_util_ds_buf_0_4 is
  port (
    BUFG_I : in STD_LOGIC_VECTOR ( 0 to 0 );
    BUFG_O : out STD_LOGIC_VECTOR ( 0 to 0 )
  );
  attribute NotValidForBitStream : boolean;
  attribute NotValidForBitStream of LVDS_to_AXIS_util_ds_buf_0_4 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of LVDS_to_AXIS_util_ds_buf_0_4 : entity is "LVDS_to_AXIS_util_ds_buf_0_4,util_ds_buf,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of LVDS_to_AXIS_util_ds_buf_0_4 : entity is "yes";
  attribute x_core_info : string;
  attribute x_core_info of LVDS_to_AXIS_util_ds_buf_0_4 : entity is "util_ds_buf,Vivado 2024.2";
end LVDS_to_AXIS_util_ds_buf_0_4;

architecture STRUCTURE of LVDS_to_AXIS_util_ds_buf_0_4 is
  ...
  attribute x_interface_parameter of BUFG_I : signal is "XIL_INTERFACENAME BUFG_I, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN LVDS_to_AXIS_l_clk_in_n, INSERT_VIP 0";
  ...
  attribute x_interface_parameter of BUFG_O : signal is "XIL_INTERFACENAME BUFG_O, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN LVDS_to_AXIS_l_clk_in_n, INSERT_VIP 0";
begin
U0: entity work.LVDS_to_AXIS_util_ds_buf_0_4_util_ds_buf
     port map (
      BUFGCE_CE(0) => '0',
      BUFGCE_CLR(0) => '0',
      BUFGCE_I(0) => '0',
