...
HD_PWD='C:/Users/marce/OneDrive/Desktop/zync_proj/2024.2/zybo_z7_20/gpx2_dummy/gpx2_dummy.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log microzed_axi_dma_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source microzed_axi_dma_wrapper.tcl
