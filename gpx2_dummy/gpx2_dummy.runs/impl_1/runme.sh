...
HD_PWD='C:/Users/marce/OneDrive/Desktop/zync_proj/2024.2/zybo_z7_20/gpx2_dummy/gpx2_dummy.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log microzed_axi_dma_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source microzed_axi_dma_wrapper.tcl -notrace
