...
// Command     : write_verilog -force -mode synth_stub -rename_top microzed_axi_dma_sample_generator2_0_0 -prefix
//               microzed_axi_dma_sample_generator2_0_0_ microzed_axi_dma_sample_generator2_0_0_stub.v
...
module microzed_axi_dma_sample_generator2_0_0(FrameSize, En, m_axis_aclk, m_axis_aresetn, 
  m_axis_tvalid, m_axis_tdata, m_axis_tstrb, m_axis_tlast, m_axis_tready)
/* synthesis syn_black_box black_box_pad_pin="FrameSize[7:0],En,m_axis_aresetn,m_axis_tvalid,m_axis_tdata[31:0],m_axis_tstrb[3:0],m_axis_tlast,m_axis_tready" */
/* synthesis syn_force_seq_prim="m_axis_aclk" */;
  input [7:0]FrameSize;
  input En;
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 M_AXIS_CLK CLK" *) (* X_INTERFACE_MODE = "slave" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME M_AXIS_CLK, ASSOCIATED_BUSIF M_AXIS, ASSOCIATED_RESET m_axis_aresetn, FREQ_HZ 5e+07, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN microzed_axi_dma_processing_system7_0_0_FCLK_CLK0, INSERT_VIP 0" *) input m_axis_aclk /* synthesis syn_isclock = 1 */;
