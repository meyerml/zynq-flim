...
HD_PWD='C:/Users/marce/OneDrive/Dokumente/zynq_project/photonsorting/comparator_module/comparator_module.runs/histo_pixel_clk_edge_detect_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log histo_pixel_clk_edge_detect_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source histo_pixel_clk_edge_detect_0.tcl
