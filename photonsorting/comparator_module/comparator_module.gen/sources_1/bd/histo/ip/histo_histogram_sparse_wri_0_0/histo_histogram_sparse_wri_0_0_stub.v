...
//               c:/Users/marce/OneDrive/Dokumente/zynq_project/photonsorting/comparator_module/comparator_module.gen/sources_1/bd/histo/ip/histo_histogram_sparse_wri_0_0/histo_histogram_sparse_wri_0_0_stub.v
...
(* CHECK_LICENSE_TYPE = "histo_histogram_sparse_wri_0_0,histogram_sparse_writeout,{}" *) (* CORE_GENERATION_INFO = "histo_histogram_sparse_wri_0_0,histogram_sparse_writeout,{x_ipProduct=Vivado 2024.2,x_ipVendor=xilinx.com,x_ipLibrary=module_ref,x_ipName=histogram_sparse_writeout,x_ipVersion=1.0,x_ipCoreRevision=1,x_ipLanguage=VERILOG,x_ipSimLanguage=MIXED,NUM_BINS=512}" *) (* DowngradeIPIdentifiedWarnings = "yes" *) 
(* IP_DEFINITION_SOURCE = "module_ref" *) (* X_CORE_INFO = "histogram_sparse_writeout,Vivado 2024.2" *) 
module histo_histogram_sparse_wri_0_0(en, clk, aresetn, pixel_done, TLAST_COUNT, 
  tdata_in, tvalid_in, tready_in, tlast_in, tdata_out, tvalid_out, tready_out, tlast_out)
/* synthesis syn_black_box black_box_pad_pin="en,aresetn,pixel_done,TLAST_COUNT[7:0],tdata_in[63:0],tvalid_in,tready_in,tlast_in,tdata_out[63:0],tvalid_out,tready_out,tlast_out" */
