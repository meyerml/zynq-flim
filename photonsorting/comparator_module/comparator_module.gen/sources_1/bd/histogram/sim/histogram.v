...
//Command     : generate_target histogram.bd
//Design      : histogram
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "histogram,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=histogram,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=6,numReposBlks=6,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=3,numPkgbdBlks=0,bdsource=USER,synth_mode=Hierarchical}" *) (* HW_HANDOFF = "histogram.hwdef" *) 
module histogram
   (AXIS_IN_tdata,
    AXIS_IN_tlast,
    AXIS_IN_tready,
    ...
    pulses_per_pixel,
    refres_p);
  (* X_INTERFACE_INFO = "xilinx.com:interface:axis:1.0 AXIS_IN TDATA" *) (* X_INTERFACE_MODE = "Slave" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME AXIS_IN, CLK_DOMAIN histogram_clk, FREQ_HZ 100000000, HAS_TKEEP 0, HAS_TLAST 1, HAS_TREADY 1, HAS_TSTRB 0, INSERT_VIP 0, LAYERED_METADATA undef, PHASE 0.0, TDATA_NUM_BYTES 8, TDEST_WIDTH 0, TID_WIDTH 0, TUSER_WIDTH 0" *) input [63:0]AXIS_IN_tdata;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface:axis:1.0 M_AXIS TDATA" *) (* X_INTERFACE_MODE = "Master" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME M_AXIS, CLK_DOMAIN histogram_clk, FREQ_HZ 100000000, HAS_TKEEP 0, HAS_TLAST 1, HAS_TREADY 1, HAS_TSTRB 0, INSERT_VIP 0, LAYERED_METADATA undef, PHASE 0.0, TDATA_NUM_BYTES 8, TDEST_WIDTH 0, TID_WIDTH 0, TUSER_WIDTH 0" *) output [63:0]M_AXIS_tdata;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.CLK CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.CLK, ASSOCIATED_BUSIF AXIS_IN:M_AXIS, ASSOCIATED_RESET aresetn, CLK_DOMAIN histogram_clk, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, INSERT_VIP 0, PHASE 0.0" *) input clk;
  ...
  histogram_axis_data_fifo_0_0 axis_data_fifo_0
  ...
  histogram_comparator_0 comparator
  ...
  histogram_histogram_0_0 histogram_0
       (.aresetn(aresetn),
        .clk(clk),
        .en(en),
        .pixel_done(refres_p),
  ...
  histogram_in_line_and_in_frame_0 in_line_and_in_frame
       (.Op1(line_clk),
        .Op2(frame_clk),
        .Res(in_line_and_in_frame_Res));
  histogram_pixel_clk_edge_detect_0 pixel_clk_edge_detect
       (.aresetn(aresetn),
        .clk(clk),
        .detect_out(refres_p),
        .edge_in(pixel_clk));
  histogram_util_vector_logic_0_0 util_vector_logic_0
