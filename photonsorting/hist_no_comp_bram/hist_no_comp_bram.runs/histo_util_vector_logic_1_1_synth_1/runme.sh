...
HD_PWD='C:/Users/marce/OneDrive/Dokumente/zynq_project/photonsorting/comparator_module/comparator_module.runs/histo_util_vector_logic_1_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log histo_util_vector_logic_1_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source histo_util_vector_logic_1_1.tcl
