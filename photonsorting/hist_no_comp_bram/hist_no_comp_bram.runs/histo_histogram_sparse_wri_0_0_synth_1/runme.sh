...
HD_PWD='C:/Users/marce/OneDrive/Dokumente/zynq_project/photonsorting/comparator_module/comparator_module.runs/histo_histogram_sparse_wri_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log histo_histogram_sparse_wri_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source histo_histogram_sparse_wri_0_0.tcl
