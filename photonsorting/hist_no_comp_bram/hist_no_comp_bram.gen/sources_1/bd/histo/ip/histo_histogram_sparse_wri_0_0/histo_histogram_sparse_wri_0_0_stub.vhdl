...
-- Date        : Tue Dec  2 13:45:50 2025
-- Host        : LAPTOP-UKM8GMC3 running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode synth_stub
--               c:/Users/marce/OneDrive/Dokumente/zynq_project/photonsorting/comparator_module/comparator_module.gen/sources_1/bd/histo/ip/histo_histogram_sparse_wri_0_0/histo_histogram_sparse_wri_0_0_stub.vhdl
-- Design      : histo_histogram_sparse_wri_0_0
...
entity histo_histogram_sparse_wri_0_0 is
  Port ( 
    en : in STD_LOGIC;
    clk : in STD_LOGIC;
    aresetn : in STD_LOGIC;
    pixel_done : in STD_LOGIC;
    TLAST_COUNT : in STD_LOGIC_VECTOR ( 7 downto 0 );
  ...
  attribute CHECK_LICENSE_TYPE of histo_histogram_sparse_wri_0_0 : entity is "histo_histogram_sparse_wri_0_0,histogram_sparse_writeout,{}";
  attribute CORE_GENERATION_INFO : string;
  attribute CORE_GENERATION_INFO of histo_histogram_sparse_wri_0_0 : entity is "histo_histogram_sparse_wri_0_0,histogram_sparse_writeout,{x_ipProduct=Vivado 2024.2,x_ipVendor=xilinx.com,x_ipLibrary=module_ref,x_ipName=histogram_sparse_writeout,x_ipVersion=1.0,x_ipCoreRevision=1,x_ipLanguage=VERILOG,x_ipSimLanguage=MIXED,NUM_BINS=512}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of histo_histogram_sparse_wri_0_0 : entity is "yes";
  attribute IP_DEFINITION_SOURCE : string;
  attribute IP_DEFINITION_SOURCE of histo_histogram_sparse_wri_0_0 : entity is "module_ref";
end histo_histogram_sparse_wri_0_0;

architecture stub of histo_histogram_sparse_wri_0_0 is
  attribute syn_black_box : boolean;
  attribute black_box_pad_pin : string;
  attribute syn_black_box of stub : architecture is true;
  attribute black_box_pad_pin of stub : architecture is "en,clk,aresetn,pixel_done,TLAST_COUNT[7:0],tdata_in[63:0],tvalid_in,tready_in,tlast_in,tdata_out[63:0],tvalid_out,tready_out,tlast_out";
  ...
  attribute X_CORE_INFO of stub : architecture is "histogram_sparse_writeout,Vivado 2024.2";
begin
end;
