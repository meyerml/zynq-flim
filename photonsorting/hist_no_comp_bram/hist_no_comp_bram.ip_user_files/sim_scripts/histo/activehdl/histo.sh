...
#                script (type 'histo.sh -help' for more information).
#
...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="C:/Users/marce/OneDrive/Dokumente/zynq_project/photonsorting/comparator_module/comparator_module.cache/compile_simlib/activehdl"
  fi
  if [[ ($lib_map_path != "") ]]; then
