...
HD_PWD='C:/Users/marce/OneDrive/Dokumente/zynq_project/photonsorting/signal_generator/signal_generator.runs/signal_generator_axi_gpio_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log signal_generator_axi_gpio_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source signal_generator_axi_gpio_0_1.tcl
