...
HD_PWD='C:/Users/marce/OneDrive/Dokumente/zynq_project/photonsorting/sg_stream/sg_stream.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log signal_generator_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source signal_generator_wrapper.tcl -notrace
