...
HD_PWD='C:/Users/marce/OneDrive/Dokumente/zynq_project/photonsorting/sg_stream/sg_stream.runs/signal_generator_histo_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log signal_generator_histo_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source signal_generator_histo_0_0.tcl
