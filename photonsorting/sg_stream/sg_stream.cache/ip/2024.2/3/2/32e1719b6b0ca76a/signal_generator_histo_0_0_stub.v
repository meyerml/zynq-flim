...
(* CHECK_LICENSE_TYPE = "signal_generator_histo_0_0,histo,{}" *) (* CORE_GENERATION_INFO = "signal_generator_histo_0_0,histo,{x_ipProduct=Vivado 2024.2,x_ipVendor=xilinx.com,x_ipLibrary=user,x_ipName=histo,x_ipVersion=4.7,x_ipCoreRevision=2,x_ipLanguage=VERILOG,x_ipSimLanguage=MIXED}" *) (* DowngradeIPIdentifiedWarnings = "yes" *) 
