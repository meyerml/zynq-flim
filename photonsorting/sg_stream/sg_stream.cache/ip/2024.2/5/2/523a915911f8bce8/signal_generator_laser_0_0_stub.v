...
(* CHECK_LICENSE_TYPE = "signal_generator_laser_0_0,laser,{}" *) (* CORE_GENERATION_INFO = "signal_generator_laser_0_0,laser,{x_ipProduct=Vivado 2024.2,x_ipVendor=xilinx.com,x_ipLibrary=user,x_ipName=laser,x_ipVersion=2.5,x_ipCoreRevision=2,x_ipLanguage=VERILOG,x_ipSimLanguage=MIXED}" *) (* DowngradeIPIdentifiedWarnings = "yes" *) 
