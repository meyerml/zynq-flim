...
(* CHECK_LICENSE_TYPE = "signal_generator_laser_0_0,laser,{}" *) (* CORE_GENERATION_INFO = "signal_generator_laser_0_0,laser,{x_ipProduct=Vivado 2024.2,x_ipVendor=xilinx.com,x_ipLibrary=user,x_ipName=laser,x_ipVersion=2.1,x_ipCoreRevision=2,x_ipLanguage=VERILOG,x_ipSimLanguage=MIXED}" *) (* DowngradeIPIdentifiedWarnings = "yes" *) 
...
module decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix(CNTVALUEOUT, S_AXI_araddr, S_AXI_arprot, 
  ...
  TRIG_IN_trig, axi_aresetn, axi_clk, bram_wraparound, en, frame_clk, image_size, laser_aresetn, 
  laser_clk, line_clk, pixel_clk, pulses_per_pixel, refclk_out, stop_out)
/* synthesis syn_black_box black_box_pad_pin="CNTVALUEOUT[4:0],S_AXI_araddr[16:0],S_AXI_arprot[2:0],S_AXI_arready,S_AXI_arvalid,S_AXI_awaddr[16:0],S_AXI_awprot[2:0],S_AXI_awready,S_AXI_awvalid,S_AXI_bready,S_AXI_bresp[1:0],S_AXI_bvalid,S_AXI_rdata[31:0],S_AXI_rready,S_AXI_rresp[1:0],S_AXI_rvalid,S_AXI_wdata[31:0],S_AXI_wready,S_AXI_wstrb[3:0],S_AXI_wvalid,TRIG_IN_ack,TRIG_IN_trig,axi_aresetn,bram_wraparound[17:0],en,frame_clk,image_size[31:0],laser_aresetn,line_clk,pixel_clk,pulses_per_pixel[31:0],refclk_out,stop_out" */
/* synthesis syn_force_seq_prim="axi_clk" */
/* synthesis syn_force_seq_prim="laser_clk" */;
  output [4:0]CNTVALUEOUT;
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 S_AXI ARADDR" *) (* X_INTERFACE_MODE = "slave" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME S_AXI, DATA_WIDTH 32, PROTOCOL AXI4LITE, FREQ_HZ 50000000, ID_WIDTH 0, ADDR_WIDTH 17, AWUSER_WIDTH 0, ARUSER_WIDTH 0, WUSER_WIDTH 0, RUSER_WIDTH 0, BUSER_WIDTH 0, READ_WRITE_MODE READ_WRITE, HAS_BURST 0, HAS_LOCK 0, HAS_PROT 1, HAS_CACHE 0, HAS_QOS 0, HAS_REGION 0, HAS_WSTRB 1, HAS_BRESP 1, HAS_RRESP 1, SUPPORTS_NARROW_BURST 0, NUM_READ_OUTSTANDING 1, NUM_WRITE_OUTSTANDING 1, MAX_BURST_LENGTH 1, PHASE 0.0, NUM_READ_THREADS 1, NUM_WRITE_THREADS 1, RUSER_BITS_PER_BYTE 0, WUSER_BITS_PER_BYTE 0, CLK_DOMAIN signal_generator_processing_system7_0_0_FCLK_CLK0, INSERT_VIP 0" *) input [16:0]S_AXI_araddr;
