...
HD_PWD='C:/Users/marce/OneDrive/Dokumente/zynq_project/photonsorting/hist_stream/hist_stream.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log histo_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source histo_wrapper.tcl
