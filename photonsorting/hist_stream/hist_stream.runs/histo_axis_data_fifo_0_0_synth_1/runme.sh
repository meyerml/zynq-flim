...
HD_PWD='C:/Users/marce/OneDrive/Dokumente/zynq_project/photonsorting/hist_stream/hist_stream.runs/histo_axis_data_fifo_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log histo_axis_data_fifo_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source histo_axis_data_fifo_0_0.tcl
