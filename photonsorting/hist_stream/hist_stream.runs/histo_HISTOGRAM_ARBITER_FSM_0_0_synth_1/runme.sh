...
HD_PWD='C:/Users/marce/OneDrive/Dokumente/zynq_project/photonsorting/hist_stream/hist_stream.runs/histo_HISTOGRAM_ARBITER_FSM_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log histo_HISTOGRAM_ARBITER_FSM_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source histo_HISTOGRAM_ARBITER_FSM_0_0.tcl
