...
#
# Script generated by Vivado on Mon Feb 23 19:00:31 +0100 2026
...
#
# Usage        : histo.sh
#                histo.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                histo.sh [-reset_run]
#                histo.sh [-reset_log]
#                histo.sh [-help]
#
...
# script info
echo -e "histo.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./histo.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L axis_infrastructure_v1_1_1 -L axis_data_fifo_v2_0_15 -L util_vector_logic_v2_0_4 -L xlconstant_v1_1_9 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot histo xil_defaultlib.histo xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim histo -key {Behavioral:block_design_elaborate_new:Functional:histo} -tclbatch cmd.tcl -protoinst "protoinst_files/histo.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb histo.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./histo.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: histo.sh [-help]\n\
Usage: histo.sh [-step]\n\
Usage: histo.sh [-lib_map_path]\n\
Usage: histo.sh [-reset_run]\n\
Usage: histo.sh [-reset_log]\n\
Usage: histo.sh [-keep_index]\n\
Usage: histo.sh [-noclean_files]\n\n\
