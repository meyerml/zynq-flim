...
HD_PWD='C:/Users/marce/OneDrive/Dokumente/zynq_project/photonsorting/emulator_4x8bit/emulator_4x8bit.runs/laser_ila_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log laser_ila_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source laser_ila_0_1.tcl
