...
HD_PWD='C:/Users/marce/OneDrive/Dokumente/zynq_project/photonsorting/emulator_4x8bit/emulator_4x8bit.runs/laser_laser_signal_generat_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log laser_laser_signal_generat_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source laser_laser_signal_generat_0_0.tcl
