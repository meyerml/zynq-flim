...
#
# Script generated by Vivado on Thu Apr 24 11:33:37 +0200 2025
# SW Build 5239630 on Fri Nov 08 22:35:27 MST 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : testbench_spi_fifo.sh
...
#
# Usage        : testbench_spi_fifo.sh
#                testbench_spi_fifo.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                testbench_spi_fifo.sh [-reset_run]
#                testbench_spi_fifo.sh [-reset_log]
#                testbench_spi_fifo.sh [-help]
#
...
# script info
echo -e "testbench_spi_fifo.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./testbench_spi_fifo.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L fifo_generator_v13_2_11 -L util_vector_logic_v2_0_4 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot testbench_spi_fifo xil_defaultlib.testbench_spi_fifo xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim testbench_spi_fifo -key {Behavioral:sim_spi_and_fifo:Functional:testbench_spi_fifo} -tclbatch cmd.tcl -protoinst "protoinst_files/testbench_spi_fifo.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb testbench_spi_fifo.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./testbench_spi_fifo.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: testbench_spi_fifo.sh [-help]\n\
Usage: testbench_spi_fifo.sh [-step]\n\
Usage: testbench_spi_fifo.sh [-lib_map_path]\n\
Usage: testbench_spi_fifo.sh [-reset_run]\n\
Usage: testbench_spi_fifo.sh [-reset_log]\n\
Usage: testbench_spi_fifo.sh [-keep_index]\n\
Usage: testbench_spi_fifo.sh [-noclean_files]\n\n\
