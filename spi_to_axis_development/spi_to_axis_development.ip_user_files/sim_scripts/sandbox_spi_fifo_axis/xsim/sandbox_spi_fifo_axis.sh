...
#
# Script generated by Vivado on Thu Apr 24 14:44:19 +0200 2025
# SW Build 5239630 on Fri Nov 08 22:35:27 MST 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : sandbox_spi_fifo_axis.sh
...
#
# Usage        : sandbox_spi_fifo_axis.sh
#                sandbox_spi_fifo_axis.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                sandbox_spi_fifo_axis.sh [-reset_run]
#                sandbox_spi_fifo_axis.sh [-reset_log]
#                sandbox_spi_fifo_axis.sh [-help]
#
...
# script info
echo -e "sandbox_spi_fifo_axis.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./sandbox_spi_fifo_axis.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L fifo_generator_v13_2_11 -L util_vector_logic_v2_0_4 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot sandbox_spi_fifo_axis xil_defaultlib.sandbox_spi_fifo_axis xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim sandbox_spi_fifo_axis -key {Behavioral:sim_spi_fifo_axis:Functional:sandbox_spi_fifo_axis} -tclbatch cmd.tcl -protoinst "protoinst_files/design_1.protoinst" -protoinst "protoinst_files/testbench_spi_fifo.protoinst" -protoinst "protoinst_files/sandbox_spi_fifo_axis.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb sandbox_spi_fifo_axis.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./sandbox_spi_fifo_axis.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: sandbox_spi_fifo_axis.sh [-help]\n\
Usage: sandbox_spi_fifo_axis.sh [-step]\n\
Usage: sandbox_spi_fifo_axis.sh [-lib_map_path]\n\
Usage: sandbox_spi_fifo_axis.sh [-reset_run]\n\
Usage: sandbox_spi_fifo_axis.sh [-reset_log]\n\
Usage: sandbox_spi_fifo_axis.sh [-keep_index]\n\
Usage: sandbox_spi_fifo_axis.sh [-noclean_files]\n\n\
