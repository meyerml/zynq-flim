...
#
# Script generated by Vivado on Thu Apr 24 13:58:47 +0200 2025
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L fifo_generator_v13_2_11 -L util_vector_logic_v2_0_4 -L xlconstant_v1_1_9 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot sandbox_spi_fifo_axis xil_defaultlib.sandbox_spi_fifo_axis xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim sandbox_spi_fifo_axis -key {Behavioral:sim_spi_fifo_axis:Functional:sandbox_spi_fifo_axis} -tclbatch cmd.tcl -protoinst "protoinst_files/testbench_spi_fifo.protoinst" -protoinst "protoinst_files/sandbox_spi_fifo_axis.protoinst" -log simulate.log
}
