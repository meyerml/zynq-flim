...
#                script (type 'sandbox_spi_fifo_axis.sh -help' for more information).
#
...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="C:/Users/marce/OneDrive/Desktop/zync_proj/2024.2/zybo_z7_20/spi_to_axis_development/spi_to_axis_development.cache/compile_simlib/activehdl"
  fi
  if [[ ($lib_map_path != "") ]]; then
