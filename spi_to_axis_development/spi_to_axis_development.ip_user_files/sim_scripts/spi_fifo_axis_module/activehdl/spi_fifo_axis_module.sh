...
#                script (type 'spi_fifo_axis_module.sh -help' for more information).
#
...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="C:/Users/marce/OneDrive/Dokumente/zynq_project/spi_to_axis_development/spi_to_axis_development.cache/compile_simlib/activehdl"
  fi
  if [[ ($lib_map_path != "") ]]; then
