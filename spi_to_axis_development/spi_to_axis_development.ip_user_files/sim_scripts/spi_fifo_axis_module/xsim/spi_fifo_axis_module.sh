...
#
# Script generated by Vivado on Thu May 15 15:07:59 +0200 2025
...
simulate()
{
  xsim spi_fifo_axis_module -key {Behavioral:sim_2:Functional:spi_fifo_axis_module} -tclbatch cmd.tcl -protoinst "protoinst_files/spi_fifo_axis_module.protoinst" -log simulate.log
}
