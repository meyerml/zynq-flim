...
#
# Script generated by Vivado on Fri May 23 14:01:00 +0200 2025
# SW Build 5239630 on Fri Nov 08 22:35:27 MST 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : spi_fifo_axis_module.sh
...
#
# Usage        : spi_fifo_axis_module.sh
#                spi_fifo_axis_module.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                spi_fifo_axis_module.sh [-reset_run]
#                spi_fifo_axis_module.sh [-reset_log]
#                spi_fifo_axis_module.sh [-help]
#
...
# script info
echo -e "spi_fifo_axis_module.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./spi_fifo_axis_module.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L fifo_generator_v13_2_11 -L util_vector_logic_v2_0_4 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot spi_fifo_axis_module xil_defaultlib.spi_fifo_axis_module xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim spi_fifo_axis_module -key {Behavioral:sim_spi_fifo_axis:Functional:spi_fifo_axis_module} -tclbatch cmd.tcl -protoinst "protoinst_files/spi_fifo_axis_module.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb spi_fifo_axis_module.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./spi_fifo_axis_module.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: spi_fifo_axis_module.sh [-help]\n\
Usage: spi_fifo_axis_module.sh [-step]\n\
Usage: spi_fifo_axis_module.sh [-lib_map_path]\n\
Usage: spi_fifo_axis_module.sh [-reset_run]\n\
Usage: spi_fifo_axis_module.sh [-reset_log]\n\
Usage: spi_fifo_axis_module.sh [-keep_index]\n\
Usage: spi_fifo_axis_module.sh [-noclean_files]\n\n\
