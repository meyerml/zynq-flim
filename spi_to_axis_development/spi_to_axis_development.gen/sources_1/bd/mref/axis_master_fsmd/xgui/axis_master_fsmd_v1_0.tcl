...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "FrameSize" -parent ${Page_0}
...
proc update_PARAM_VALUE.FrameSize { PARAM_VALUE.FrameSize } {
	# Procedure called to update FrameSize when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.FrameSize { PARAM_VALUE.FrameSize } {
	# Procedure called to validate FrameSize
	return true
}
...
proc update_MODELPARAM_VALUE.FrameSize { MODELPARAM_VALUE.FrameSize PARAM_VALUE.FrameSize } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.FrameSize}] ${MODELPARAM_VALUE.FrameSize}
}
