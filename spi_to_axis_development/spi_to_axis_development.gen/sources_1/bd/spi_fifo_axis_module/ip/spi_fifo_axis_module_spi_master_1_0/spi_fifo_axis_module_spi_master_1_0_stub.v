...
module spi_fifo_axis_module_spi_master_1_0(aresetn, i_clk, o_rx_byte_valid_tick, 
  o_rx_byte, i_buffer_full, o_spi_clk, i_spi_miso, o_spi_mosi, o_cs_n, i_intr, i_spi_en, 
  o_byte_done_tick, o_transfer_done_tick, o_ready)
/* synthesis syn_black_box black_box_pad_pin="aresetn,o_rx_byte_valid_tick,o_rx_byte[7:0],i_buffer_full,o_spi_clk,i_spi_miso,o_spi_mosi,o_cs_n,i_intr,i_spi_en,o_byte_done_tick,o_transfer_done_tick,o_ready" */
