...
//               c:/Users/marce/OneDrive/Dokumente/zynq_project/spi_to_axis_development/spi_to_axis_development.gen/sources_1/bd/spi_fifo_axis_module/ip/spi_fifo_axis_module_axi_stream_master_0_0/spi_fifo_axis_module_axi_stream_master_0_0_stub.v
...
(* CHECK_LICENSE_TYPE = "spi_fifo_axis_module_axi_stream_master_0_0,axi_stream_master,{}" *) (* CORE_GENERATION_INFO = "spi_fifo_axis_module_axi_stream_master_0_0,axi_stream_master,{x_ipProduct=Vivado 2024.2,x_ipVendor=xilinx.com,x_ipLibrary=module_ref,x_ipName=axi_stream_master,x_ipVersion=1.0,x_ipCoreRevision=1,x_ipLanguage=VERILOG,x_ipSimLanguage=MIXED,C_M_AXIS_TDATA_WIDTH=32,FrameSize=16}" *) (* DowngradeIPIdentifiedWarnings = "yes" *) 
(* IP_DEFINITION_SOURCE = "module_ref" *) (* X_CORE_INFO = "axi_stream_master,Vivado 2024.2" *) 
module spi_fifo_axis_module_axi_stream_master_0_0(m_axis_aclk, m_axis_aresetn, fifo_empty, 
  fifo_read_data, m_axis_tready, m_axis_tvalid, m_axis_tdata, m_axis_tstrb, m_axis_tlast, 
  fifo_read_en)
/* synthesis syn_black_box black_box_pad_pin="m_axis_aresetn,fifo_empty,fifo_read_data[31:0],m_axis_tready,m_axis_tvalid,m_axis_tdata[31:0],m_axis_tstrb[3:0],m_axis_tlast,fifo_read_en" */
