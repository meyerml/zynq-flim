...
HD_PWD='C:/Users/marce/OneDrive/Dokumente/zynq_project/spi_to_axis_development/spi_to_axis_development.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log spi_fifo_axis_module_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source spi_fifo_axis_module_wrapper.tcl
