...
HD_PWD='C:/Users/marce/OneDrive/Dokumente/zynq_project/zedboard_custom_board/zedboard_custom_board.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log spi_to_dma_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source spi_to_dma_wrapper.tcl -notrace
