...
module spi_to_dma (
  ...
  (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.SPI_SCLK, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN spi_to_dma_spi_multiplexer_0_0_spi_clk, INSERT_VIP 0" *)
  output spi_sclk;
  (* X_INTERFACE_IGNORE = "true" *)
  output spi_cs_n;
  (* X_INTERFACE_IGNORE = "true" *)
