...
#                script (type 'spi_to_dma.sh -help' for more information).
#
...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="C:/Users/marce/OneDrive/Dokumente/zynq_project/zedboard_custom_board/zedboard_custom_board.cache/compile_simlib/activehdl"
  fi
  if [[ ($lib_map_path != "") ]]; then
