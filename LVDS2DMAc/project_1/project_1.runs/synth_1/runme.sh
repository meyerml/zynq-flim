...
HD_PWD='C:/Users/marce/OneDrive/Dokumente/zynq_project/LVDS_to_DMA_LVDS_customizable/LVDS_to_DMA_LVDS_customizable.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log spi_to_dma_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source spi_to_dma_wrapper.tcl
